...
func (this *IncomeController) ParseJSON(json []byte) (interface{}, error) {
	var entities = make([]*entity.Income, 0)
...
func init() {
	incomeController = &IncomeController{
		BaseController: controller.BaseController{
			BaseService: service.GetIncomeService(),
		},
	}
	incomeController.BaseController.ParseJSON = incomeController.ParseJSON
	container.RegistController("income", incomeController)
}
