...
var balanceSheetController *BalanceSheetController

func (this *BalanceSheetController) ParseJSON(json []byte) (interface{}, error) {
	var entities = make([]*entity.BalanceSheet, 0)
...
func init() {
	balanceSheetController = &BalanceSheetController{
		BaseController: controller.BaseController{
			BaseService: service.GetBalanceSheetService(),
		},
	}
	balanceSheetController.BaseController.ParseJSON = balanceSheetController.ParseJSON
	container.RegistController("balanceSheet", balanceSheetController)
}
